...
# About message
aboutMsg="$(cat <<EOU
This downloads and installs Winston 99 as a vapp on a hosted domain
Winston 99 resides in www/vapps/winston99.DOMAIN.TLD; html/DOMAIN.TLD links to it, like WordPress
EOU
)"
...
declare -A optDesc
optName[d]="Domain"
optDesc[d]="The hosted domain or subdomain to install Winston 99 on"
optName[b]="Database"
