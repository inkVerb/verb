...
# About message
aboutMsg="$(cat <<EOU
This modifies settings for a Winston Press vapp already installed on a hosted domain
Writes verb/conf/vapps/winstonpress.DOMAIN.config and restarts the service
EOU
)"
...
declare -A optDesc
optName[d]="Domain"
optDesc[d]="The hosted domain where Winston Press is installed"
optName[b]="Database"
