...
# About message
aboutMsg="$(cat <<EOU
This modifies settings for a badAd vapp already installed on a hosted domain
Writes verb/conf/vapps/badad.DOMAIN.config and restarts the service
EOU
)"
...
declare -A optDesc
optName[d]="Domain"
optDesc[d]="The hosted domain where badAd is installed"
optName[b]="Database"
...
optDesc[k]="Any config key (web_url, mail_from, ...)"
...
# Message prep
success_message="badAd settings updated on ${SOd}."
fail_message="badAd settings failed to update on ${SOd}."
