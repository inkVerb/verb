...
# About message
aboutMsg="$(cat <<EOU
This deletes a mailbox from the installed mail stack.
EOU
)"
...
# Message prep
success_message="This deletes a mailbox from the installed mail stack."
fail_message="Command failed."

# Prepare command
serfcommand="${Serfs}/inkmail delbox ${SOu} ${SOd}"
